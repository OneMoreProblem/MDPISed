...
%=================================================================
\documentclass[fluids,article,submit,moreauthors,pdftex]{Definitions/mdpi} 
...
\begin{figure}[!ht]
    ...
    \end{tikzpicture}
    \caption{asdfasfd $\theta = sin \frac{\omega}{N}$}
    \label{fig:domainup}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \begin{tikzpicture}[scale=1, z={(-.707,-.5)}]
    \draw[pattern=dots] (3.6,0,0) -- (0,0,0) -- (0,4,0)--(6,4,0)--(3.6,0,0);
    %\draw (3.6,0,0) -- (3.6,0,-1) -- (6,4,-1) -- (6,4,0) -- cycle;
    %\draw (6,4,0) -- (0,4,0) -- (0,4,-1) -- (6,4,-1);
    \draw (-0.5,2,0) node{};
    \draw (4.1,-.2,-1.5) node{};
